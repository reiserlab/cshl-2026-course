...
const yamlFiles = [
  ...
  'protocols/shared/p3_heisenberg_ts_short.yaml',
  'protocols/shared/p3_heisenberg_ts_full.yaml',
  'protocols/shared/p3_heisenberg_high_low_short.yaml',
  'protocols/shared/p3_heisenberg_high_low_full.yaml',
  'protocols/shared/p3_heisenberg_slashes_short.yaml',
  'protocols/shared/p3_heisenberg_slashes_full.yaml',
  'protocols/shared/p3_heisenberg_relational_short.yaml',
  'protocols/shared/p3_heisenberg_relational_full.yaml',
  'protocols/shared/p3_dill_random_checkers_short.yaml',
  'protocols/shared/p3_dill_random_checkers_full.yaml'
];
