...
> **Course SD card:** Copy the 40 `.pat` files from the course repository's
> [unified SD bundle](https://github.com/reiserlab/cshl-2026-course/tree/main/patterns/course_sd)
> directly to the SD-card root. Do not combine the separate protocol pattern
> folders; the shared protocol YAMLs use the bundle's global IDs.
