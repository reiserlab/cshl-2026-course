...
| Choice | Global SD ID | Student choice | What differs |
| ---: | ---: | --- | --- |
| 1 | 36 | Classic T figures | Upright versus inverted T |
| 2 | 37 | High/low bars | Vertical position |
| 3 | 38 | Left/right slashes | +45° versus -45° edge orientation |
| 4 | 39 | Relational slashes | Which slash orientation is above the other |
| 5 | 40 | Dill random squares | Two randomized, quadrant-filling square textures |
...
---
*Last updated 2026-07-10. Pattern source: `patterns/p3_conditioning/`; unified
SD bundle: `patterns/course_sd/`.*
