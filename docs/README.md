# CSHL 2026 — Course Guide

Welcome! These pages are your reference for running fly experiments on the
LED-arena rigs. Read them in roughly this order; each is short and practical.
...
- **[Protocol overview](protocols/README.md)** — the p0–p3 series at a glance.
  ...
  - [p3 — (coming soon)](protocols/p3.md)
